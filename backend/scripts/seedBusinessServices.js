...
// ============================================================
// 🚀 Script لإدراج خدمات الأعمال والاقتصاد تلقائياً
// ============================================================
// الاستخدام:
//   cd backend
...
// ============================================================
// 📚 البيانات: الأقسام الرئيسية لخدمات الأعمال
// ============================================================
const SECTIONS_DATA = [
  {
    ...
    descriptionAr: 'خدمات إدارة الأعمال والتوجيه الإداري',
    icon: 'fa-briefcase',
    order: 1,
  },
  {
    ...
    description: 'Finance & accounting services',
    descriptionAr: 'خدمات المالية والمحاسبة',
    icon: 'fa-calculator',
    order: 2,
  },
  {
    ...
    descriptionAr: 'خدمات التسويق والدراسات التسويقية',
    icon: 'fa-bullhorn',
    order: 3,
  },
  {
    ...
    nameAr: 'الاقتصاد',
    slug: 'economics',
    description: 'Economics services',
    descriptionAr: 'خدمات الاقتصاد والتحليل الاقتصادي',
    icon: 'fa-chart-line',
    order: 4,
  },
  {
    ...
    slug: 'operations',
    description: 'Operations & production services',
    descriptionAr: 'خدمات إدارة العمليات والإنتاج',
    icon: 'fa-industry',
    order: 5,
  },
  {
    name: 'Reports & Applied Studies',
    nameAr: 'التقارير والدراسات التطبيقية',
    slug: 'business-reports',
    description: 'Reports & applied studies services',
    descriptionAr: 'خدمات إعداد ومراجعة التقارير والدراسات التطبيقية',
    icon: 'fa-file-alt',
    order: 6,
  },
];
...
// ============================================================
// 📋 البيانات: 29 خدمة أعمال
// ============================================================
const SERVICES_DATA = [
  // ============================================================
  // 💼 القسم 1: إدارة الأعمال (5 خدمات)
  // ============================================================
  {
    ...
    descriptionAr: 'توجيه أكاديمي في تحليل الحالات الإدارية وتنظيم المعلومات وربطها بالنماذج الإدارية',
    icon: 'fa-file-alt',
  ...
  },
  {
    ...
    descriptionAr: 'مراجعة أكاديمية للتقارير الإدارية مع تحسين تنظيم المحتوى وجودة التحليل',
    icon: 'fa-file-lines',
  ...
  },
  {
    ...
    descriptionAr: 'توجيه في تطبيق النماذج الإدارية على الحالات والمشاريع التطبيقية',
    icon: 'fa-sitemap',
  ...
  },
  {
    ...
    descriptionAr: 'توجيه أكاديمي في بناء خطط المشاريع وتنظيم أهدافها ومراحل تنفيذها',
    icon: 'fa-list-check',
  ...
  },
  {
    ...
    descriptionAr: 'مراجعة أكاديمية لدراسات الجدوى مع تحليل الجوانب التشغيلية والمالية',
  ...
  // ============================================================
  // 💰 القسم 2: المالية والمحاسبة (5 خدمات)
  // ============================================================
  {
    ...
    descriptionAr: 'تطوير نماذج مالية أكاديمية لتنظيم البيانات وعرض التوقعات',
    icon: 'fa-calculator',
  ...
  },
  {
    ...
    descriptionAr: 'تحليل أكاديمي لنموذج العمل باستخدام Business Model Canvas',
    icon: 'fa-cube',
  ...
  // ============================================================
  // ⚙️ القسم 5: العمليات والإنتاج (5 خدمات)
  // ============================================================
  {
    section: 'operations',
  ...
  // ============================================================
  // 📊 القسم 6: التقارير والدراسات التطبيقية (5 خدمات)
  // ============================================================
  {
...
const seedBusinessServices = async () => {
  try {
    ...
    // 1. إنشاء الأقسام
    // ============================================================
    console.log('📂 Creating business sections...');
