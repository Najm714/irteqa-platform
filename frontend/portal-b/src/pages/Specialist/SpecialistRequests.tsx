// frontend/portal-a/src/pages/Specialist/SpecialistRequests.tsx
import React, { useState, useEffect } from 'react';
import { useAuth } from '../../context/AuthContext';
import { Link, useNavigate } from 'react-router-dom';
import { FaSpinner, FaEye, FaClock, FaCheckCircle, FaTimesCircle, FaFileAlt, FaUser, FaMoneyBill, FaCalendarAlt, FaSearch, FaFilter, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
    ...
    <div className="space-y-4">
      ...
      {requests.length > 0 ? (
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                  <div className="flex-1">
                    ...
                    <h4 className="font-bold text-gray-900 dark:text-white mt-1">{request.title}</h4>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-200 dark:border-gray-700">
          ...
          <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2">لا توجد طلبات مسندة</h4>
