// frontend/portal-a/src/pages/Register.tsx
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await register({
        ...
        fullName: formData.fullName,
        username: formData.username || formData.fullName.split(' ')[0],
      });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? <FaSpinner className="animate-spin mx-auto" /> : 'إنشاء حساب'}
          </button>
        </form>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <Link to="/login" className="text-purple-600 dark:text-purple-400 font-semibold hover:underline mr-1">
            تسجيل الدخول
          </Link>
        </div>
      </div>
