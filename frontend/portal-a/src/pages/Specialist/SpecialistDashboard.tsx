          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                {showNotifications && (
                  <div className="absolute left-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 z-50 max-h-96 overflow-y-auto">
                    ...
                    {notifications.length > 0 ? (
                      notifications.slice(0, 10).map((notif: any, index: number) => (
                        <div key={index} className={`p-3 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition ${!notif.read ? 'bg-purple-50 dark:bg-purple-900/10' : ''}`}>
